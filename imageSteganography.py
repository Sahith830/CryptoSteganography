...
from commonUtils import USER_IMAGE_FILE
from cryptographyAlgorithms import decryptData, encryptData


def encrypt(image_path,textToBeHidden):
    '''
    ...
    msg = bytes(textToBeHidden,'utf-8')
    msg = encryptData(msg)
    msg = msg.decode('utf-8')
    print(msg)
    # msg = "Sample Text to be hidden inside an image"
...
# decrypt("uploads/userImageFile_hidden.bmp")